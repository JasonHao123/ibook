...
public class MethodSecurityEvaluationContext extends StandardEvaluationContext {
    ...
    private void addArgumentsAsVariables() {
        ...
        ParamName annotation =mi.getMethod().getAnnotation(ParamName.class);
        if(annotation!=null) {
            paramNames = annotation.value();
        }else {
        ...
        if (paramNames == null) {
            logger.warn("Unable to resolve method parameter names for method: " + mi.getMethod()
