...
<c:choose>
	...
	<h3 class="ui-collapsible-heading ui-collapsible-heading-collapsed">
		<a href="<c:url value="/job/search.do" ><c:param name="category" value="${category.name}" /></c:url>" class="ui-collapsible-heading-toggle ui-btn ui-btn-icon-right ui-btn-inherit ui-icon-carat-d">
	...
	<div class="ui-collapsible-content ui-body-inherit ui-collapsible-content-collapsed" aria-hidden="true">
		...
		<c:forEach items="${category.children}" var="subCategory">
			<li><a href="<c:url value="/job/search.do" ><c:param name="subCategory" value="${subCategory.name}" /></c:url>" data-ajax="false"> ${subCategory.name }</a></li>	
	</c:forEach>
	</ul>
	</div>
</li>
